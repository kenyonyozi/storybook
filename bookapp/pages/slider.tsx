...
<div id="animation-carousel" className="relative" data-carousel="static">
    ...
    <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div className="hidden duration-200 ease-linear" data-carousel-item>
            <Image src={projectImage} alt="Picture of the author" width={500} height={500} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" />
        </div>
